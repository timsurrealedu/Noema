...
- Completed backend roadmap: note history and Markdown interchange, unified search, AI routing fixtures, study courses/assignments/quizzes/spaced review, notifications/push subscriptions, scheduled automations with run metrics, encrypted backup verification and retention, health/disk checks, redacted logs, v1 import, and hardened deployment templates.
- Next priorities: (1) ~~compiler Git worktree sessions and host-enforced cgroups~~ done; (2) optional 2FA, external calendar/BinusMaya sync, semantic ranking, full workspace export, and streaming agent sessions; (3) frontend verification.
