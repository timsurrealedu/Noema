...
export const sessionCookie="noema_session";
export const workspaceCookie="noema_workspace";
const legacySessionCookie="lifeos_session",legacyWorkspaceCookie="lifeos_workspace";
