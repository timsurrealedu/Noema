...
export function loadConfig(env=process.env){
  ...
  const config={
    ...
    codexPath:env.LIFEOS_CODEX_PATH||"codex",sessionHours:Number(env.LIFEOS_SESSION_HOURS||24*30),compileTimeoutMs:Number(env.LIFEOS_COMPILE_TIMEOUT_MS||10000),maxOutputBytes:Number(env.LIFEOS_MAX_OUTPUT_BYTES||262144),backupKey:env.LIFEOS_BACKUP_KEY||"",backupRetention:Number(env.LIFEOS_BACKUP_RETENTION||14),minFreeBytes:Number(env.LIFEOS_MIN_FREE_BYTES||1073741824),
  };
