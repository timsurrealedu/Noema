...
export function openDatabase(path){
  ...
  for(const table of ["captures","tasks","events","notes","projects","assets","automations","courses","assignments","study_cards","quizzes","notifications","jobs","knowledge_nodes","knowledge_edges","dashboards"]){ensureColumn(db,table,"workspace_id","TEXT")}
