...
const handlers={"interpret-capture":handleInterpretCapture,"note-optimize":handleOptimizeNote,"skill-run":handleRunSkill,"handwriting-ocr":handleHandwritingOcr,"handwriting-intake":handleHandwritingIntake};
