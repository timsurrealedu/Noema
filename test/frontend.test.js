...
test("ink exposes world-edit transforms and geometric tool types",()=>{const ink=read("app/lib/ink.ts");for(const tool of ["rectangle","ellipse","arrow","rotateStroke","scaleStroke"])assert.match(ink,new RegExp(tool))});
