...
test("Home formats canonical task timestamps instead of displaying ISO strings",()=>{const home=read("app/page.tsx");assert.match(home,/taskDue/);assert.match(home,/<time>\{mobileTaskDue\(task\)\}<\/time>/)});
