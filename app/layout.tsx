...
export default function RootLayout({children}:{children:React.ReactNode}) {
  return <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning><body><Script id="noema-theme" strategy="beforeInteractive">{themeScript}</Script><MobileNavigation/><AppStateProvider>{children}<NavigationWarmup/><PWARegister/><ServiceNotice/><PageMotion/></AppStateProvider></body></html>;
}
