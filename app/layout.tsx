...
export default function RootLayout({children}:{children:React.ReactNode}) {
  return <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning><body><Script id="noema-theme" strategy="beforeInteractive">{themeScript}</Script><AppStateProvider>{children}<MobileNavigation/><NavigationWarmup/><PWARegister/><ServiceNotice/><PageMotion/></AppStateProvider></body></html>;
}
