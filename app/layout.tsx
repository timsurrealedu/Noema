...
export default function RootLayout({children}:{children:React.ReactNode}) {
  return <html lang="en" suppressHydrationWarning><body><Script id="noema-theme" strategy="beforeInteractive">{themeScript}</Script><AppStateProvider>{children}<NavigationWarmup/><PWARegister/><ServiceNotice/><PageMotion/></AppStateProvider></body></html>;
}
