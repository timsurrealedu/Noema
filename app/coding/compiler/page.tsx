...
import {ArrowLeft, CheckCircle, Play, Terminal, WarningCircle} from "@phosphor-icons/react";
...
export default function CompilerPage(){
  const [language,setLanguage]=useState<Language>("javascript"),[code,setCode]=useState(starters.javascript),[result,setResult]=useState<Result|null>(null),[error,setError]=useState(""),[running,setRunning]=useState(false);
