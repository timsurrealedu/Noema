...
Cohesion: 0.06
Nodes (64): POST(), DELETE(), GET(), GET(), GET(), GET(), POST(), GET() (+56 more)

### Community 1 - "json"
Cohesion: 0.11
Nodes (45): POST(), GET(), POST(), POST(), DELETE(), DELETE(), GET(), POST() (+37 more)
...
### Community 18 - "knowledge-graph.mjs"
Cohesion: 0.26
...
## Knowledge Gaps
- **155 isolated node(s):** `config`, `target`, `dom`, `dom.iterable`, `esnext` (+150 more)
...
- **Why does `getDatabase()` connect `db.mjs` to `json`, `projects.mjs`, `google-calendar.mjs`, `dashboards.mjs`, `approvals.mjs`, `annotations.mjs`, `skills.mjs`, `knowledge-graph.mjs`, `objects.mjs`, `push.mjs`, `worker.mjs`?**
...
- **Should `json` be split into smaller, more focused modules?**
  _Cohesion score 0.11281826163301141 - nodes in this community are weakly interconnected._
